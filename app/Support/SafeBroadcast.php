 ...
 * teman, dll). Tanpa pembungkus ini, satu broadcast yang gagal melempar
 * BroadcastException dan menggagalkan seluruh HTTP request -- mis. user jadi
 * tak bisa logout hanya karena WebSocket down.
 *
