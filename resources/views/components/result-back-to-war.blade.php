...
--}}
{{-- data-result-primary: this is the primary action on a war result, so it is what the result
     page's Tab shortcut focuses (see typing-result.blade.php). --}}
<a href="{{ route('clan-war.index') }}" data-result-primary
