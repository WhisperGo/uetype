<nav x-data="{ open: false }" class="sticky top-0 z-40 border-b border-white/5 bg-typing-bg/80 backdrop-blur-md">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:gap-4 sm:ms-6">
                @auth
                    <!-- Quick stats pill -->
                    <div class="flex items-center gap-3 px-3 py-1.5 rounded-full bg-typing-surface border border-white/5 text-xs font-mono">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden border-t border-white/5">
        ...
        <div class="pt-4 pb-1 border-t border-white/5">
            ...
            @else
                <div class="px-4"><div class="text-base font-medium text-typing-text">Tamu</div></div>
                <div class="mt-3 space-y-1">
