...
return [
    ...
    'what_is_body' => 'UeType adalah aplikasi mengetik berbasis web yang mengubah latihan menjadi permainan. Selain tes mengetik standar, tersedia mode Survival, Ghost, dan Multiplayer real-time, dengan sistem level dan papan peringkat agar tiap sesi terasa berharga.',

    'team' => 'Tim',
    'built_with' => 'Dibuat dengan',

    // Overlay profil member (dibuka saat kartu tim diklik).
