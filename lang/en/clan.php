...
return [
    ...
    'war' => [
        ...
        'accept' => 'Accept',
        'decline' => 'Decline',
        // Shown to ordinary members in place of the Accept/Decline buttons: the challenge stays
        // visible, only the action that was never theirs goes away.
        'awaiting_officers' => 'Waiting on your clan leader or a co-leader to respond.',
        ...
        'cancel_challenge' => 'Withdraw Challenge',
        'ongoing' => 'War Ongoing',
        'vs_prefix' => 'vs',
        ...
        'modes_hint' => 'Claim an open mode, then start your attempt. Each mode can only be done once by your clan, and you get one attempt at it. You may claim up to :max modes.',
        ...
        'not_in_war' => 'Your clan is not in a war right now. Ask your leader or a co-leader to challenge another clan.',
    ...
    'modal' => [
        ...
        'cancel_challenge_title' => 'Withdraw this challenge?',
        'cancel_challenge_body' => 'The other clan will be told you withdrew. Both clans are free to start a new war straight away.',
        'cancel_challenge_confirm' => 'Withdraw Challenge',
    ...
    'notify' => [
        ...
        'war_cancelled' => ':clan withdrew their Clan War challenge',
